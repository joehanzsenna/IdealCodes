...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'Most projects are delivered in 2–4 weeks depending on scope. E-commerce or complex platforms may take 4–6 weeks. We agree on a timeline before starting and keep you updated throughout.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Every project includes: design, development, mobile responsiveness, basic SEO (meta tags, sitemap), contact form, Google Analytics, and deployment. What varies is the number of pages and features.',
  },
  {
  ...
  },
  {
    ...
    answer: '50% upfront and 50% on delivery. For larger projects, we can arrange milestone-based payments. Reach out and we\'ll work something out.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We hand over hosting credentials, CMS access, and a walkthrough. We offer ongoing support packages and are always reachable on WhatsApp if something comes up.',
  },
  {
